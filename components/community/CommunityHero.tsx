...
export default function CommunityHero() {
  return (
    <section className="relative min-h-[560px] sm:min-h-[700px] h-screen w-full overflow-hidden bg-black text-white">
      {/* Background Image */}
      <img
      ...
      {/* Content Container */}
      <div className="relative z-10 h-full w-full max-w-[1600px] mx-auto px-4 sm:px-8 md:px-12 lg:px-16 flex flex-col justify-end pb-8 sm:pb-16 md:pb-20 lg:pb-24">
        <div className="w-full flex justify-end">
          ...
          >
            {/* Main Headline */}
            <h1 className="font-serif text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-[4.8rem] font-normal leading-[1.05] sm:leading-[0.98] tracking-[-0.015em] text-white">
