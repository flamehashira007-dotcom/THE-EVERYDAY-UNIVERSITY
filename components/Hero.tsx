...
export default function Hero() {
  ...
  // On mobile, all parallax transforms are static (no JS-driven scroll motion)
  const videoY = useTransform(scrollYProgress, [0, 1], isMobile ? ["0%", "0%"] : ["0%", "18%"]);
  const titleY = useTransform(scrollYProgress, [0, 1], isMobile ? ["0%", "0%"] : ["0%", "-30%"]);
  const titleOpacity = useTransform(scrollYProgress, [0, 0.6], isMobile ? [1, 1] : [1, 0]);

  const badgeLeftY = useTransform(scrollYProgress, [0, 1], isMobile ? ["0%", "0%"] : ["0%", "-40%"]);
  const badgeRightY = useTransform(scrollYProgress, [0, 1], isMobile ? ["0%", "0%"] : ["0%", "-60%"]);
