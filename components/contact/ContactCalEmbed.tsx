      ...
      <div className="mx-auto max-w-5xl space-y-12">
        ...
        <div className="mx-auto max-w-2xl text-center space-y-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 pt-2 text-xs font-semibold text-neutral-300">
            ...
            <span className="inline-flex items-center gap-1.5">
              <ShieldCheck className="h-4 w-4 text-[#facc15]" /> Direct Team Review
            </span>
          </div>
        </div>
        ...
        >
          ...
          <div className="mb-6 flex flex-wrap items-center justify-between gap-3 border-b border-white/10 pb-5">
            <div className="flex items-center gap-2 text-xs font-medium text-neutral-300">
              <span className="font-bold text-white">Select a Date & Time</span>
              <span className="text-neutral-600">•</span>
              <span className="text-neutral-400">Timezone: Eastern Time (EST)</span>
            </div>
              ...
              >
                ...
                <div className="space-y-3 max-w-md">
                  ...
                  <p className="text-sm leading-relaxed text-neutral-300">
                    We&rsquo;ve received your 30-minute intro call request for <span className="text-white font-bold">{clientName || "our team"}</span>.
                  </p>
                  ...
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-left space-y-2 text-xs text-neutral-300 mt-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-bold text-white">Google Meet / Video Link</span>
                    </div>
                    <div className="flex items-center justify-between">
